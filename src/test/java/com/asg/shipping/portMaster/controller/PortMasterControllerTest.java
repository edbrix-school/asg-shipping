...
import com.asg.shipping.portMaster.controller.PortMasterController;
...
class PortMasterControllerTest {
    ...
    void createPort_Success() throws Exception {
        ...
        mockMvc.perform(post("/v1/port-master")
                        .param("groupPoid", "1001")
    ...
    void updatePort_Success() throws Exception {
        ...
        mockMvc.perform(put("/v1/port-master/1")
                        .param("groupPoid", "1001")
                        .param("userPoid", "admin")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
    ...
    void getPortById_Success() throws Exception {
        ...
        mockMvc.perform(get("/v1/port-master/1")
                        .param("groupPoid", "1001"))
                .andExpect(status().isOk());
    ...
    void getAllPorts_Success() throws Exception {
        ...
        Map<String, Object> responseMap = Map.of(
                "content", List.of(createMockResponse()),
                "totalElements", 1,
                "totalPages", 1
        );
        ...
        mockMvc.perform(get("/v1/port-master/list")
                        .param("page", "0")
                        .param("size", "10")
                        .param("sort", "portName,asc")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void deletePort_Success() throws Exception {
        ...
        mockMvc.perform(delete("/v1/port-master/1")
                        .param("groupPoid", "1001")
                        .param("userPoid", "admin"))
                .andExpect(status().isOk());
