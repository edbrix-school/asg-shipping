...
public class BookingFormMapper {
     ...
     */
    public static BookingFormDto mapToDto(ShipMateHdr entity) {
        if (entity == null) {
            return null;
        }
     ...
     */
    public static void mapCreateDTOToEntity(BookingFormCreateDTO dto, ShipMateHdr entity, Long groupPoid, Long companyPoid) {
    ...
    private static BookingFormCargoDetailDto mapCargoDtlToDto(ShipMateCargoDtl entity) {
        if (entity == null)
            return null;
    ...
    public static ShipMateCargoDtl mapCargoDtlFromDto(BookingFormCargoDetailDto dto, Long transactionPoid) {
        if (dto == null)
            return null;
    ...
    public static BookingFormChargesDetailDto mapChargesDtlToDto(ShipMateChargesDtl entity) {
        if (entity == null)
            return null;
    ...
    public static ShipMateChargesDtl mapChargesDtlFromDto(BookingFormChargesDetailDto dto, Long transactionPoid) {
        if (dto == null)
            return null;
    ...
    public static BookingFormContainerDetailDto mapContainerDtlToDto(ShipMateContainerDtl entity) {
        if (entity == null)
            return null;
    ...
    public static List<BookingFormCargoDetailDto> mapCargoDtlListToDto(List<ShipMateCargoDtl> entities) {
        if (entities == null)
            return null;
    ...
    public static List<BookingFormChargesDetailDto> mapChargesDtlListToDto(List<ShipMateChargesDtl> entities) {
        if (entities == null)
            return null;
        return entities.stream().map(BookingFormMapper::mapChargesDtlToDto).collect(Collectors.toList());
    }

    public static List<BookingFormContainerDetailDto> mapContainerDtlListToDto(List<ShipMateContainerDtl> entities) {
        if (entities == null)
            return null;
