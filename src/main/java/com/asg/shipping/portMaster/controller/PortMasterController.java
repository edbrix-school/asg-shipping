...
public class PortMasterController {
    ...
    public ResponseEntity<?> create(
        ...
        Map<String, Object> response = service.createPort(request);
    ...
    public ResponseEntity<?> update(
        ...
        PortMasterResponse response = service.updatePort(portPoid, request);
    ...
    public ResponseEntity<?> getById(
        ...
        PortMasterResponse response = service.getPortById(portPoid);
