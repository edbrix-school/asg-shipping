...
/**
 * Entity class for SHIP_LINE_TARIFF_EXP_PAY_DTL table (Export Detention Payable)
 */
@Entity
@Table(name = "SHIP_LINE_TARIFF_EXP_PAY_DTL")
@IdClass(ShipLineTariffExpPayDtlId.class)
@Getter
@Setter
@NoArgsConstructor
public class ShipLineTariffExpPayDtl extends BaseEntity {
