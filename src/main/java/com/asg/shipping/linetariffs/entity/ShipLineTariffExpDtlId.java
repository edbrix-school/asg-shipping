...
/**
 * Composite primary key for ShipLineTariffExpDtl
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ShipLineTariffExpDtlId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ShipLineTariffExpDtlId that = (ShipLineTariffExpDtlId) o;
