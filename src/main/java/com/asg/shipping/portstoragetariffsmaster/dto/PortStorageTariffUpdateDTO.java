...
/**
 * Request DTO for updating an existing Port Storage Tariff
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class PortStorageTariffUpdateDTO {
    ...
    @Valid
    private List<TariffDetailUpdateDTO> tariffDetails; // Detail records to update/create/delete
}
