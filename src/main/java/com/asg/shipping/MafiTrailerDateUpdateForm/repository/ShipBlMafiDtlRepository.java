...
public interface ShipBlMafiDtlRepository
        extends JpaRepository<ShipBlMafiDtl, ShipBlMafiDtlId> {

    List<ShipBlMafiDtl> findByIdTransactionPoidOrderByIdDetRowId(Long transactionPoid);

    Optional<ShipBlMafiDtl> findByIdTransactionPoidAndIdDetRowId(
