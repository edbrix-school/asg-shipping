...
/**
 * Request DTO for creating Vessel Master
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(description = "Vessel Master creation request")
public class VesselMasterCreateDTO {

    @NotBlank(message = "Vessel Code is mandatory")
    @Size(max = 20, message = "Vessel code cannot exceed 20 characters")
    @Schema(description = "Vessel Code", required = true, example = "VSL001")
