 ...
 * Export Manifest Update OPS – BL (100 – 352)
 */
@Entity
@Table(name = "SHIP_BL_MANIFEST_HDR",
        uniqueConstraints = {
                @UniqueConstraint(name = "UK_SHIP_BL_MANIFEST_VOYBL", columnNames = {"VOYAGE_TRANSACTION_POID", "BL_NUMBER"}),
                @UniqueConstraint(name = "UK_DOCREFFSHIP_BL_MANIFEST_HDR", columnNames = {"DOC_REF"})
        })
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class ShipBlManifestHdr {
    ...
    @Column(name = "TOTAL_VOLUME", precision = 25, scale = 3)
    private BigDecimal totalVolume;

    @Column(name = "TOTAL_NET_VOLUME", precision = 25, scale = 3)
    private BigDecimal totalNetVolume;

    @Column(name = "TOTAL_WEIGHT", precision = 25, scale = 3)
    private BigDecimal totalWeight;

    @Column(name = "TOTAL_NET_WEIGHT", precision = 25, scale = 3)
    ...
    @Column(name = "TOTAL_NO_OF_PACKS", precision = 20, scale = 2)
    ...
    @Column(name = "DEM_RATE", precision = 25, scale = 3)
