...
public class ShipBlManifestHDR {
    ...
    protected void onCreate() {
        ...
        if (manifestEmailVerified == null) {
            manifestEmailVerified = "N";
        }
        if (emailVerifiedWithSpecialC == null) {
            emailVerifiedWithSpecialC = "N";
        }
    }
