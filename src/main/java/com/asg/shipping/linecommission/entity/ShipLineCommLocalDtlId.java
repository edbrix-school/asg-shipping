...
/**
 * JPA IdClass for SHIP_LINE_COMM_LOCAL_DTL (composite PK: TRANSACTION_POID + DET_ROW_ID).
 */
public class ShipLineCommLocalDtlId implements Serializable {

    private Long transactionPoid;
    private Long detRowId;

    public ShipLineCommLocalDtlId() {}

    public ShipLineCommLocalDtlId(Long transactionPoid, Long detRowId) {
    ...
    public boolean equals(Object o) {
        ...
        ShipLineCommLocalDtlId that = (ShipLineCommLocalDtlId) o;
