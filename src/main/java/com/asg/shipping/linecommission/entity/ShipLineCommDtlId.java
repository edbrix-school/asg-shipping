...
/**
 * JPA IdClass for SHIP_LINE_COMM_DTL (composite PK: TRANSACTION_POID + DET_ROW_ID).
 */
public class ShipLineCommDtlId implements Serializable {
    private Long transactionPoid;
    private Long detRowId;

    public ShipLineCommDtlId() {}

    public ShipLineCommDtlId(Long transactionPoid, Long detRowId) {
    ...
    public boolean equals(Object o) {
        ...
        ShipLineCommDtlId that = (ShipLineCommDtlId) o;
